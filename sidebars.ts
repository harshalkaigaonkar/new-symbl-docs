const sidebars = {
 "Home": [
  {
   type: 'Documentation',
   link: '', // no href is required here because of redirect on './next.config.js' file.
   id: 'introduction'
  },
  {
   type: 'What is Symbl?',
  ...
  }, 
  {
   ...
   items: [
    {
     type: 'Introduction',
     link: 'conversation-api/concepts/speech-to-text',
     id: 'speech-to-text'
    },
    {
     type: 'Real-Time Speech-to-Text',
     link: 'how-tos/get-speech-to-text-real-time',
     id: 'get-speech-to-text-real-time'
    },
    {
     type: 'Async Speech-to-Text',
     link: 'how-tos/get-speech-to-text-async',
  ...
  },
  {
   ...
   items: [
    {
     type: "Introduction",
     link: "conversation-api/concepts/summary-topic",
     id: "topics"
    },
    {
     type: "Real-Time Topics",
     link: "how-tos/get-topics",
     id: "how-to-get-topics"
    },
    {
     type: "Async Topics",
     link: "how-tos/get-topics#async-api",
     id: "how-to-get-topics#async"
    },
   ]
  },
  {
    type: "Abstract Topics",
    items: [
     {
      type: "Introduction",
      link: "guides/abstract-topics",
      id: "abstract-topics"
     },
    ]
   },
   {
    ...
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/action-items",
      id: "action-items"
     },
    ]
   },
   {
    ...
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/sentiment",
      id: "sentiment"
     },
    ]
   }, 
   {
    ...
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/follow-ups",
      id: "follow-ups"
     },
    ]
   }, 
   {
    ...
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/questions",
      id: "questions"
     },
]
},
{
    ...
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/trackers",
      id: "trackers"
     },
]
},
{
    type: "Conversation Analytics",
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/analytics",
      id: "analytics"
     },
]
},
{
    type: "Topic Hierarchy",
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/topic-hierarchy",
      id: "topic-hierarchy"
     },
]
},
{
    ...
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/summarization",
      id: "summarization"
     },
]
},
{
    type: "Comprehensive Action Items (Labs)",
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/comprehensive-action-items",
      id: "comprehensive-action-items"
     },
]
},
{
    type: "Conversation Groups (Beta)",
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/conversation-groups",
...
},
{
    ...
    items: [
     {
      type: "Introduction",
      link: "conversation-api/concepts/ui-components",
      id: "ui-components"
     },
]
},
 ...
 "APIs": [
  ...
  },
  {
   ...
   link: "api-reference/getting-conversation-intelligence"
  },
  {
   type: "Authentication",
   link: "developer-tools/authentication"
  },
  {
   type: "Streaming API",
   items: [
    {
     type: "Introduction",
     link: "streamingapi/introduction"
    },
    {
